...
import { Search, Users, UserCheck, UserX, TrendingUp, Calendar, Mail, Phone, MapPin, Eye } from 'lucide-react'
...
export const Students: React.FC = () => {
  ...
  const classes = ['all', 'Class 10-A', 'Class 10-B', 'Class 9-A', 'Class 9-B']
